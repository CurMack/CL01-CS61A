...
def is_swap(player_score, opponent_score):
    ...
    "*** YOUR CODE HERE ***"
    o1 = player_score % 10
    t2, o2 = (opponent_score %100)// 10, opponent_score % 10
    delta = abs(o1 - o2)
    if delta == t2:
        return True
    else:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if feral_hogs and abs(num_rolls - pre_score0) == 2:
                score0 += 3
            pre_score0 = take_turn(num_rolls, score1, dice)
            score0 += pre_score0
            if is_swap(score0, score1):
                score0, score1 = score1, score0
        else:
            num_rolls = strategy1(score1, score0)
            if feral_hogs and abs(num_rolls - pre_score1) == 2:
                score1 += 3
            pre_score1 = take_turn(num_rolls, score0, dice)
            score1 += pre_score1
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if change > running_high:
            ...
            return announce_highest(who, new_score, change)
        else:
...
def make_averaged(original_function, trials_count=1000):
    ...
    def average(*args):
        ...
        for i in range(0, trials_count):
            tmp_sum += original_function(*args)
        return tmp_sum / trials_count
    return average
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    tmp_max , max_roll = 0 , 0
    for i in range(1, 11):
        tmp_sum = 0
        for j in range(0, trials_count):
            tmp_sum += roll_dice(i, dice)
        if tmp_sum > tmp_max:
            max_roll = i
            tmp_max = tmp_sum
    return max_roll
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if is_swap(score + bacon, opponent_score):
        if opponent_score > (score + bacon):
            return 0
        elif opponent_score < (score + bacon):
            return num_rolls
    if bacon >= cutoff:
        return 0
    else:
